...
Read it top to bottom, then open the two files it points to.
...
with embedded SQLite. Targets any OpenAI-compatible endpoint.

## 2. Where we are right now

- **Current phase:** see [`tasks/roadmap.md`](tasks/roadmap.md).
